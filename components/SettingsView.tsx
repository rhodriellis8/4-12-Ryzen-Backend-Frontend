        ...
        <div className="bg-white dark:bg-zinc-900/50 border border-zinc-200 dark:border-white/5 rounded-xl p-6 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" defaultValue="John Doe" className="w-full px-3 py-2 bg-zinc-50 dark:bg-black/50 border border-zinc-200 dark:border-white/10 rounded-md text-sm text-zinc-900 dark:text-zinc-200 focus:outline-none focus:border-zinc-400 dark:focus:border-zinc-600 transition-colors" />
                </div>
                <div>
                    <label className="block text-xs font-medium text-zinc-500 mb-1.5">Email Address</label>
                    <input type="email" defaultValue="john@example.com" className="w-full px-3 py-2 bg-zinc-50 dark:bg-black/50 border border-zinc-200 dark:border-white/10 rounded-md text-sm text-zinc-900 dark:text-zinc-200 focus:outline-none focus:border-zinc-400 dark:focus:border-zinc-600 transition-colors" />
                </div>
            </div>
        </div>
